...
int main(int argc, char** argv) {
    ...
    SimulatedTape in_tape = SimulatedTape::CreateWithFile(
            in_file_name, DelayConfig::GetConfigPath(), MEM_LIMIT_BYTES);
    SimulatedTape out_tape =
            SimulatedTape::Create(out_file_prefix, DelayConfig::GetConfigPath(), MEM_LIMIT_BYTES);
